...
import com.example.auth_service.service.GoogleTokenValidator;
import com.example.auth_service.service.UserContext;
...
public class AuthController {
    ...
    public ResponseEntity<Long> getUserId(@PathVariable String email) {
        ...
        Long userId = authService.getUserByEmail(email);
        return new ResponseEntity<>(userId, HttpStatus.OK);
    }

    @PostMapping("/forgotPassword")
    public ResponseEntity<?> forgotPassword(@RequestBody String emailReq){
        authService.sendForgotPasswordOtp(emailReq);
